...
var BorderStyle = PropTypes.oneOf(['solid', 'dotted', 'dashed']);
var Color = PropTypes.oneOfType([PropTypes.string, PropTypes.number]);
var Overflow = PropTypes.oneOf(['visible', 'hidden', 'scroll']);
exports.default = {
    color: Color,
    shadowColor: Color,
