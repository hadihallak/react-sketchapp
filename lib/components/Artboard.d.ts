...
export declare const ArtboardPropTypes: {
    ...
    isHome: PropTypes.Requireable<boolean>;
    children: PropTypes.Requireable<PropTypes.ReactNodeLike>;
    viewport: PropTypes.Requireable<PropTypes.InferProps<{
        name: PropTypes.Requireable<string>;
        width: PropTypes.Requireable<number>;
        height: PropTypes.Requireable<number>;
    }>>;
};
export declare type Props = PropTypes.InferProps<typeof ArtboardPropTypes>;
