...
declare const propTypes: {
    ...
    'xmlns:xlink': PropTypes.Requireable<string>;
...
export default class Svg extends React.Component<Props> {
    ...
    static ClipPath: typeof ClipPath;
    static Defs: typeof Defs;
    ...
    static TextPath: typeof TextPath;
    static TSpan: typeof TSpan;
