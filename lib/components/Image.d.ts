...
export declare const ImageSourcePropType: PropTypes.Requireable<string | PropTypes.InferProps<{
    uri: PropTypes.Validator<string>;
    height: PropTypes.Requireable<number>;
    width: PropTypes.Requireable<number>;
}>>;
export declare const ImagePropTypes: {
    ...
    defaultSource: PropTypes.Requireable<string | PropTypes.InferProps<{
        uri: PropTypes.Validator<string>;
        height: PropTypes.Requireable<number>;
        width: PropTypes.Requireable<number>;
    }>>;
...
export declare type Props = PropTypes.InferProps<typeof ImagePropTypes>;
