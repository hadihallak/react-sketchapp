...
function makeResizeConstraint(resizingConstraint) {
    if (resizingConstraint) {
        var constraints = [];
        var top_1 = resizingConstraint.top, right = resizingConstraint.right, bottom = resizingConstraint.bottom, left = resizingConstraint.left, fixedHeight = resizingConstraint.fixedHeight, fixedWidth = resizingConstraint.fixedWidth;
        if (top_1) {
...
exports.default = makeResizeConstraint;
